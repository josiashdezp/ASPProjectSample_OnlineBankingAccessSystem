...
'Ahora vamos a armar el estado de cuentas y crear el mensaje.
    ...
    Response.Write " <title>Estado de Cuentas por Email</title> "&vbcrlf
    Response.Write " </head><script language=javascript type=text/javascript> function Salvar()  {document.execCommand('SaveAs',false,'A:\Estado de Cuentas.html');window.close();}</script>"&vbcrlf
	Response.Write "<body onLoad=Salvar() ><div align=center> "&vbcrlf
	Response.Write " <P><B><div align=left><font color=#000000 face=Verdana size=3>Estado de Cuentas.</font></b></p>"&vbcrlf
	Response.Write " <hr size=1 color=#000000 align=left> "&vbcrlf

'Según la cantidad de cuentas es la cantidad de estados de cuentas que hay que hacer
for i = 1 to contador
		 Cta = Cuentas(i)
			...
			Response.Write " <p align=right><b><font color=#000000 face=Verdana size=2>BANDEC, SUCURSAL "&sucu&", "&rsv("PLAZA")&"</font><br>"&vbcrlf
			Response.Write " <font color=#000000 face=Verdana size=2>Fecha Emisi&oacute;n: " & Date() & " </font><br>"&vbcrlf
			Response.Write " <font color=#000000 face=Verdana size=2>Cuenta: " & cta & " </font></b></p>"&vbcrlf
			Response.Write " <div align=center><center><table border=0 cellpadding=0 cellspacing=5 width='100%'><tr><td align=center colspan=6><hr color=#000000 size=1></td></tr>"&vbcrlf
			Response.Write " <tr><td width=8% align=center><p align=center><font face=Arial size='2'><strong>Fecha Contable</strong></span></font></td>"&vbcrlf
		    Response.Write " <td width=10% align=center><p align=center><font face=Arial size='2'1px><strong>Referencia Corriente</strong></span></font></td>"&vbcrlf
			Response.Write " <td width=10% align=center><p align=center><font face=Arial size='2'><strong>Referencia Original</strong></span></font></td>"&vbcrlf
			Response.Write " <td width=50% align=center><font face=Arial size='2'><strong>Observaciones&nbsp;&nbsp;</strong></span></font></td><td width=10 align=center></td><td width=19 align=center><font face=Arial size='2'><span style=text-transform: uppercase><strong>Movimientos</strong></span></font></td></tr>"&vbcrlf
			Response.Write " <tr><td colspan=6><hr color=#000000 size=1></td></tr><tr><td width=12></td><td width=16></td><td width=15></td><td colspan=2><p align=right><strong><span style=text-transform: uppercase><font face=Arial size='2'>Saldo Anterior: </font></span></strong></td>"&vbcrlf
  ...
  set rssa = conn.Execute(querysa)
   ...
   If CDbl(rssa("IMP_ASIENT")) < 0 then cod = "Cr" else cod = "Db" End If
	...
	Response.Write " <td align=right><font face=Arial><font size=2>" & Imp_asient & " </font></font></td></tr> "&vbcrlf
	Response.Write " <tr><td width=12></td><td width=16></td><td width=15></td><td width=28><font size='2'></font></td><td colspan=2><font size='2'><hr color=#000000 width=100 size=1 align=right></font></td></tr></table></center></div>"&vbcrlf
 ...
 Do While not rs1.eof 
    ...
    Response.Write " <table border=0 cellpadding=0 cellspacing=5 width='100%'><tr> "&vbcrlf
	Response.Write " <td width=10% align=center valign=Top><p align=center><font face=Arial size='2'> " & rs1("FEC_CONTAB")& " </font></td> "&vbcrlf
	Response.Write " <td width=10% align=center valign=Top><font face=Arial><font size='2'> " & rs1("REF_CORRIE")& " </font></font></td> "&vbcrlf
	Response.Write " <td width=10% align=center valign=Top><p align=center><font face=Arial size='2'> " & rs1("REF_ORIGIN") & " </font></td> "&vbcrlf
 ...
 If inStr(Obs,"Comprobante:")<>0 then
  ...
  End If 
	...
	Response.Write " <td width=50% align=center><p align=right><font face=Arial size='2'> " & Obs & " </font></td><td width=3></td></center> "&vbcrlf
    
	If CDbl(rs1("IMP_ASIENT")) < 0 then cod = "Cr" else cod = "Db" End If
	
	Imp_asient = FormatNumber(abs(CDbl(rs1("IMP_ASIENT"))),2) & cod 
    Response.Write " <td align=right valign=Top><font size=2><font face=Arial>" & Imp_Asient & "&nbsp;&nbsp;</font></font></td></tr></table></div></div> "&vbcrlf
	Else
	Response.Write " <div align=center><center><table border=0 cellpadding=0 cellspacing=5 width='100%'><tr> "&vbcrlf
	Response.Write " <td width=10% align=center valign=Top><small><small><font face=Arial> " & rs1("FEC_CONTAB") & " </font></small></small></td> "&vbcrlf
	Response.Write " <td align=left><strong><small><small><font face=Arial> No hubo movimientos en esta fecha. </font></small></small></strong></td></tr></table></center></div> "&vbcrlf
	End If
 rs1.MoveNext 
 Loop 
	...
	Response.Write " <div align=center><center> "&vbcrlf
	Response.Write " <table border=0 cellpadding=0 cellspacing=0 width='100%'><tr><td width=9 rowspan=2></td><td width=9 rowspan=2></td><td width=9 rowspan=2></td><td width=9 rowspan=2></td><td colspan=2 rowspan=2><font size='2'></font></td><td rowspan=2 width=18><font size='2'><hr color=#000000 size=1 width=100 align=right></font></td></tr> "&vbcrlf
	Response.Write " <tr></tr><tr><td width=9></td><td width=9></td><td width=9></td><td width=9></td><td align=right colspan=2><font face=Arial size='2'><span style=text-transform: uppercase><b>Saldo final:</b></span></font></td>"&vbcrlf
	...
	Response.Write " <td align=right><font size=2><font face=Arial> " & Imp_Asient & "&nbsp;&nbsp;&nbsp;&nbsp;</font></font></td></tr> "&vbcrlf		
	

   if (subcue = "3280") or (subcue = "3290") then Saldo = "Fondo aprobado:" else  Saldo = "Sobregiro autorizado:" end if
   
	Response.Write " <tr><td width=9></td><td width=9></td><td width=9></td><td width=9></td><td align=right colspan=2><font face=Arial size='2'><span style=text-transform: uppercase><b>" & Saldo & "</b></span></font></td>"&vbcrlf
	...
	Response.Write " <tr><td width=9></td><td width=9></td><td width=9></td><td width=9></td><td align=right colspan=2><font face=Arial size='2'><span style=text-transform: uppercase><b>Fondo Reservado: </b></span></font></td>"&vbcrlf
	...
	Response.Write " <td align=right><font size=2><font face=Arial> " & Imp_Asient & "&nbsp;&nbsp;&nbsp;&nbsp;</font></font></td></tr> "&vbcrlf		
	Response.Write " <tr><td width=9></td><td width=9></td><td width=9></td><td width=9></td><td align=right colspan=2><font face=Arial size='2'><span style=text-transform: uppercase><b>Fondo Disponible:</b></span></font></td>"&vbcrlf
	...
	Response.Write " <td align=right><font size=2><font face=Arial> " & Imp_Asient & "&nbsp;&nbsp;&nbsp;&nbsp;</font></font></td></tr> "&vbcrlf		
	Response.Write " </table></center></div></div> "&vbcrlf
...
'EL PIE DE PÁGINA ES ESTE
	Response.Write " <hr size=1 color=#000000 align=left width='100%'>"&vbcrlf
	Response.Write " <font face=verdana size='2'><div align=center><b>Un servicio de Virtual Bandec.</b></div></font> "&vbcrlf
	 %>	
...
<!--
 ...
 @LANGUAGE="VBSCRIPT" CODEPAGE="1252"%>
  'Ahora es que hacemos el estado de cuentas para mandarlos por correo 
   ...
   des_cuenta = mid(cta,12,2)
	...
	Response.Write "<html><head>"
    Response.Write " <title>Estado de Cuenta por Email</title></head>"&vbcrlf 
	Response.Write "<script language=javascript type=text/javascript> function Salvar()  {document.execCommand('SaveAs',false,'c:\Estado de Cuentas.html');window.close();}</script>"
	Response.Write "<body  onLoad=Salvar()><div align=center> "&vbcrlf
	Response.Write " <P><B><div align=left><font color=#000000 face=Verdana size=3>Estado de Cuenta.</font></b></p>"&vbcrlf
	Response.Write " <hr size=1 color=#000000 align=left> "&vbcrlf
	Response.Write " <p align=right><b><font color=#000000 face=Verdana size=2>BANDEC, SUCURSAL "&sucu&", "&rsv("PLAZA")&"</font><br>"&vbcrlf
	Response.Write " <font color=#000000 face=Verdana size=2>Fecha Emisi&oacute;n: " & Date() & " </font><br>"&vbcrlf
	Response.Write " <font color=#000000 face=Verdana size=2>Cuenta: " & cta & " </font></b></p>"&vbcrlf
...
If mid(right(Cta,14),4,4) = "3360" then
 ...
 Do While not rs1.eof 
	...
	Response.Write " <td width=10% align=center valign=Top><font face=Arial><font size=2> " & rs1("REF_CORRIE")& " </font></font></td> "&vbcrlf
	Response.Write " <td width=10% align=center valign=Top><p align=center><font face=Arial size=2> " & rs1("REF_ORIGIN") & " </font></td> "&vbcrlf
	Response.Write " <td width=50% align=center><p align=right><font face=Arial size=2> " & rs1("Observ") & " </font></td><td width=3></td></center> "&vbcrlf
